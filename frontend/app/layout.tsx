...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  return <html lang="en"><body>
    <header className="border-b border-[#cfe2dd] bg-white"><div className="shell flex min-h-18 items-center justify-between gap-4 py-4">
      ...
      <span className="text-sm font-semibold text-[#49656a]">Secure care communication</span>
